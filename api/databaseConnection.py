...
class DatabaseConnection:
    ...
    def connect_to_db(self):
        conn_vals = self.config['SECRET_DATABASE_ACCESS']
        conn_dict = {
            'host':conn_vals['db_host'],
            'port':conn_vals['db_port'],
            'dbname':conn_vals['db_name'],
            'user':conn_vals['db_user'],
            'password':conn_vals['db_password']
        }
        self.db_conn = psycopg2.connect(**conn_dict)
